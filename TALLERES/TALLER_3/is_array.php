...
$miArray = ["uno", "dos", "tres", "cuatro", "cinco"]; // Reemplaza esto con tu propio array
$miString = "Hola mundo en php"; // Reemplaza esto con tu propio string
$miNumero = 12345; // Reemplaza esto con tu propio número
