...
$misAmigos = ["Armando", "Ambar", "Alex", "Isaac"]; // Reemplaza esto con tu array de amigos
array_push($misAmigos, "Lesly", "Isa"); // Reemplaza las comillas vacías con los nombres de tus amigos
